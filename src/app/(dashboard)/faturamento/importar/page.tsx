...
import { Upload, FileCheck, AlertCircle, CheckCircle, Lock } from 'lucide-react'
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[40vh] gap-4 text-center">
        ...
        <p className="text-muted-foreground max-w-sm">
          A importação de faturamento é uma funcionalidade exclusiva de <strong>Gestores</strong>.
